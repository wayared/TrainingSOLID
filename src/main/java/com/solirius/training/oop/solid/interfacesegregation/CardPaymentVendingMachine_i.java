...
public class CardPaymentVendingMachine_i implements VendingMachine_i {
    ...
    @Override
    public Product purchaseProduct(StockType stockType, Card card) throws OutOfStockException, InsufficientPaymentException, CashPaymentsNotSupportedException {
